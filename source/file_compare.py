...
class FileCompare(QMainWindow):
    ...
    def apply_stylesheet(self, theme):
        if platform.system() == 'Windows':
            ...
            theme_path = self.get_resource_path(f'resources/themes/windows_{theme}.qss')
        else:
    ...
    def load_theme(self):
        ...
        config_path = self.get_resource_path('resources/config.ini')
...
if __name__ == '__main__':
    try:
        ...
        window = FileCompare()
        icon_path = window.get_resource_path('resources/icons/icon.ico')
        #app.setWindowIcon(QIcon('../resources/icons/icon.ico'))
